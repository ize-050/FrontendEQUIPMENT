            ...
            {isUserDropdownOpen && (
              <div className={styles.dropdownMenu}>
                {user.userType === 'owner' ? (
                  // Owner menu options
                  <>
                    <Link href="/Owner/addequipment" className={styles.dropdownItem}>เพิ่มอุปกรณ์ของฉัน</Link>
                    <Link href="/Owner/listequipment" className={styles.dropdownItem}>รายการอุปกรณ์ของฉัน</Link>
