    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-blue-50">
      ...
      <main className="relative overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              'url(\'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800"><defs><pattern id="farm" patternUnits="userSpaceOnUse" width="100" height="100"><rect fill="%2334d399" width="100" height="100"/><circle fill="%2316a34a" cx="50" cy="50" r="20" opacity="0.1"/></pattern></defs><rect fill="url(%23farm)" width="1200" height="800"/></svg>\')',
          }}
        >
          <div className="text-center text-white px-4 max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight">
              ...
              <br />
              <span className="inline-block animate-bounce delay-500 text-yellow-300">
                ทุกที่ทุกเวลา
              </span>
            </h1>
