      ...
      <div className={styles.userActions}>
        {user ? (
            ...
            {isUserDropdownOpen && (
              <div className={styles.dropdownMenu}>
                {user.userType === "owner" ? (
                  ...
                  <>
                    <Link
                      href="/Owner/addequipment"
                      className={styles.dropdownItem}
                    >
                      เพิ่มอุปกรณ์ของฉัน
                    </Link>
                    <Link
                      href="/Owner/listequipment"
                      className={styles.dropdownItem}
                    >
                      รายการอุปกรณ์ของฉัน
                    </Link>
          ...
          <>
            <div className={styles.dropdownContainer}>
              <button
                className={`${styles.actionButton} ${styles.tenant}`}
              ...
              {isTenantDropdownOpen && (
                <div className={styles.dropdownMenu}>
                  <Link href="/Farmer/login" className={styles.dropdownItem}>
                    เข้าสู่ระบบ
                  </Link>
                  <Link href="/Farmer/register" className={styles.dropdownItem}>
                    สมัครสมาชิก
                  </Link>
                </div>
              )}
            ...
            <div className={styles.dropdownContainer}>
              <button
                className={`${styles.actionButton} ${styles.owner}`}
              ...
              {isOwnerDropdownOpen && (
                <div className={styles.dropdownMenu}>
                  <Link
                    href="/Owner/loginowner"
                    className={styles.dropdownItem}
                  >
                    เข้าสู่ระบบ
                  </Link>
                  <Link
                    href="/Owner/registerowner"
                    className={styles.dropdownItem}
                  >
                    สมัครสมาชิก
                  </Link>
